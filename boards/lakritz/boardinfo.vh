/* DFU Board information definitions for the Lone Dynamics Lakritz */
localparam SPI_FLASH_SIZE = (2 * 1024 * 1024);
localparam SPI_ERASE_SIZE = 4096;
localparam SPI_PAGE_SIZE  = 256;

/* Flash partition layout */
/* 256K is about twice the compressed bootloader (Lakritz is ~123KB), and
...
localparam BOARD_PID = 'h116d;  /* Lakritz DFU Bootloader */

/* String Descriptors */
localparam BOARD_MFR_NAME = "Lone Dynamics Corporation";
localparam BOARD_PRODUCT_NAME = "Lakritz DFU Bootloader";
